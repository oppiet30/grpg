...
/*
	...
	Copyright 20mysqli_n Smith / 345 Technical / 345 Group.
...
//server = themysqli_ase server (usually localhost).mysqli_mysqli_

//username = The user name to connect to the database.

//password = The password to connect to the database.

  function mysqli_nect($server = 'localhomysqli_username = 'thegrpg3', $password = 'hc6vwbrf', $database = 'thegrpg3_myneocorp', $link = 'db_link') {
...
//Function to handle datamysqli_rrors.
mysqli_
  function db_error($query, $ermysqli_error) {
mysqli_
