...
?>		
		...
		* {
		...
		<tr>
			...
			<tr>
				<td><p style='color:white;font-size:16px;font-weight:bold;'><center><?= $worked['itemname'] ?></center></p></td>
			</tr>
			</table>
			...
			<tr>
				...
				<td class='textr'><?= $worked['itemname'] ?></td>
